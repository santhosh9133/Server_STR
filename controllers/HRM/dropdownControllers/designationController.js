...
exports.createDesignation = async (req, res) => {
  try {
    const { CompanyId, name, departmentName, isActive = true } = req.body;
...
exports.updateDesignation = async (req, res) => {
  try {
    const { name, departmentName, isActive } = req.body;
    ...
    if (departmentName !== undefined) designation.departmentName = departmentName?.trim();
